	...
	public:
		virtual bool OnEvent(SEvent event){
			...
			case EGET_BUTTON_CLICKED:
				...
				if (id == 104)
				{
					fullscreen = false; //fs->isChecked();
					effect = false; //fx->isChecked();
					...
					if(mn==1){
						...
						while(a!=false){
							...
							//if(effect==true){ map += "t"; }
							//if(effect!=true){ map += "f"; }
...
int main(){
	...
	//fx = env->addCheckBox(effect, core::rect<int>(450,70,540,100),0, 3, L"Effetti");
