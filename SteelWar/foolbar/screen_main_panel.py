...
class MainGUIController(GUIController):
	...
	def __init__(self, evManager):
		...
		self.rectOfInterest = pygame.Rect( (0,380,440,100) )
...
class MainGUIView(GUIView):
	"""..."""
	clipRect = pygame.Rect( (0,380,440,100) )
	...
	def __init__(self, evManager, renderGroup, rect):
		...
		b1= ButtonSprite( evManager, "End Game", container=self,
		                  onClickEvent=menuEvent )
		b2= ButtonSprite( evManager, "Player Join", container=self,
		                  onClickEvent=joinEvent)
		b3= ButtonSprite(evManager, "Place Charactor", container=self )
		l1= LabelSprite( evManager, "Charactor", container=self )
		cb= CharactorButtons( evManager, container=self )
	...
	#----------------------------------------------------------------------
 	def ArrangeWidgets(self):
		...
		self.widgets[0].rect.topleft = vectorSum( xyOffset, (20, 0) ) 
